    ...
    <form className="max-w-lg mx-auto">
      <div className="flex">
        ...
        <div className="relative w-full">
          ...
          <button
            type="submit"
            className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-[#EF4444] rounded-e-lg border border-[#EF4444] hover:bg-[#EF4444] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <svg
              className="w-4 h-4"
              aria-hidden="true"
